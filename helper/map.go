...
func NewIntMap(cap int) *SortMap {
...
func (m *SortMap) Exists(key int) bool {
...
func (m *SortMap) Insert(key int, data interface{}) bool {
...
func (m *SortMap) Size() int {

	return len(m.keyArray)

}

func (m *SortMap) GetByOrderIndex(index int) (int, interface{}, bool) {
