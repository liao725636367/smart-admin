      ...
      <el-table
        ...
        >
          <template slot-scope="scope">
            <el-input v-model="scope.row.nums" placeholder="请输入套餐数量"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          header-align="center"
    ...
    <el-dialog @close="resetAddForm" title="添加套餐" :visible.sync="showAddForm" width="50%">
      <el-form ref="addFormRef" :model="addForm" :rules="addFormRules" label-width="100">
        <el-form-item label="行业名称">
          <el-input v-model="addForm.name" :disabled="true" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="行业套餐数" prop="nums">
          <el-input type="number" v-model="addForm.nums" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
